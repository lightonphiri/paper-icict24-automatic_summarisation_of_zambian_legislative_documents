...
\begin{figure*}%%%%%[htbp]
\fbox{%
\scalebox{0.315}{\includegraphics{figures/img-icict24-statutory_instrument12_2018.eps}}
}%
...
\begin{figure}%%%%%[htbp]
\fbox{%
\scalebox{0.65}{\includegraphics{figures/img-icict24-summary1_output.png}}
}%
\caption{Summmary 1: .}
...
\begin{figure}%%%%%[htbp]
\fbox{%
\scalebox{0.325}{\includegraphics{figures/img-icict24-summary2_output.png}}
}%
\caption{Summmary 2: .}
